    ...
    <body>
        ...
        <div class="container mt-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="?tabla=planificacion&month=<?= $prevMonth ?>&year=<?= $prevYear ?>" class="btn btn-outline-danger">
            ...
            <h3 class="text-center mb-3"><?= ucfirst(strftime('%B %Y', $firstDay)) ?></h3>
                                ...
                                if (($currentDay == 1 && $i < $dayOfWeek) || ($currentDay > $numDays)) {
                                    ...
                                    if (isset($planificaciones[$currentDate])) {
                                        foreach ($planificaciones[$currentDate] as $event) {
                                            echo '<div class="event" data-id="' . $event['id_planificacion'] . '" 
                                    ...
                                    if ($id_planta_usuario) {
                                        echo '<button class="btn btn-sm btn-outline-success w-100 mt-1 add-event" 
